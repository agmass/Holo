...
public class HoloNbtManager {
    ...
    public static HoloNbtManager createFromNbt(NbtCompound tag, MinecraftServer server) {
        ...
        playersNbt.getKeys().forEach(key -> {
            ...
            if (playersNbt.getCompound(key).contains("holoName", NbtElement.STRING_TYPE))
                playerData.holoName = playersNbt.getCompound(key).getString("holoName");
            ...
            if (playerData.cloneCompound != null) {
                ...
                playerData.cloneCompound.getKeys().forEach((k -> {
                    ...
                    if (playerData.cloneCompound.getCompound(k).contains("HoloName", NbtElement.STRING_TYPE)) {
                        Log.info(LogCategory.GENERAL,playerData.cloneCompound.getCompound(k).getString("HoloName"));
    ...
    public NbtCompound writeNbt(NbtCompound nbt) {
        ...
        players.forEach((uuid, playerData) -> {
            ...
            playerNbt.putString("holoName", playerData.holoName);
